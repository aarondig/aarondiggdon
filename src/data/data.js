export const data = [
      ...
      },
      {
        ...
        subsections: [
          ...
          },
          {
            type: "font/color",
            fonts: [
              {name: "lululemon", fontFamily: "Calibre", fontSize: "80px", fontWeight: 600, color: "#000000"},
              {name: "Calibre Regular", fontFamily: "Calibre", fontSize: "36px", fontWeight: 300, color: "#777777"},
            ],
  ...
  },
  {
    ...
    link:
      "https://googlefactchecker.herokuapp.com",
    banner:
